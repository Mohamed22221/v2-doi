...
const DeleteBrandModal = ({
    ...
    const isDeletionBlocked = itemsCount > 0
    ...
    const onConfirm = () => {
        ...
        if (selectedOption === 'disable') {
            deactivate(id.toString(), {
                onSuccess: () =>
                    onSuccess('brands.deleteModal.successDisable'),
                onError,
            })
        ...
        >
            <div className="flex flex-col items-center text-center p-2 ">
                ...
                <h3 className="mb-2 font-bold text-neutral-950 dark:text-neutral-50 text-lg">
                    {t(
                        isDeletionBlocked
                            ? 'brands.deleteModal.cannotDeleteTitle'
                            : 'brands.deleteModal.canDeleteTitle',
                    )}
                </h3>
                                    ...
                                    <div className="flex-1 text-left">
                                        <div className="flex justify-between items-center mb-1">
                                            <span className="font-semibold text-neutral-800 dark:text-neutral-100 text-sm">
                                                {t(
                                                    'brands.deleteModal.disableOption',
                                                )}
                                            </span>
                                            <Badge
                                                content="Recommended"
                                        ...
                                        <p className="text-xs text-neutral-400 leading-relaxed text-start ">
                                            {t(
                                                'brands.deleteModal.disableDescription',
                                            )}
                                        </p>
                                    </div>
                                    <Icon
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    <div className="flex justify-between items-center mb-1">
                                        <span className="font-semibold text-neutral-800 dark:text-neutral-100 text-sm">
                                            {t(
                                                'brands.deleteModal.softDeleteOption',
                                            )}
                                        </span>
                                        <Badge
                                            content="Recommended"
                                    ...
                                    <p className="text-xs text-neutral-400 leading-relaxed text-start">
                                        {t(
                                            'brands.deleteModal.softDeleteDescription',
                                        )}
                                    </p>
                                </div>
                                <Icon
                        ...
                        <div className="flex items-start  gap-4 w-full">
                            ...
                            <div className="flex-1 text-start">
                                <span className="font-semibold text-neutral-800 dark:text-neutral-100 text-sm block mb-1">
                                    {t('brands.deleteModal.bulkMoveOption')}
                                </span>
                                <p className="text-xs text-neutral-400 leading-relaxed ltr:mr-8 rtl:ml-8">
                                    {t(
                                        'brands.deleteModal.bulkMoveDescription',
                                    )}
                                </p>
                            </div>
                            <Icon
                        ...
                        {selectedOption === 'move' && (
                            ...
                            >
                                <label className="block text-[11px] font-bold text-primary-500 dark:text-primary-100  uppercase tracking-wider mb-2">
                                    {t(
                                        'brands.deleteModal.destinationLabel',
                                    )}
                                </label>
                                <CategorySelect
                                    size="sm"
                                    placeholder={t(
                                        'brands.deleteModal.destinationPlaceholder',
                                    )}
                                    maxMenuHeight={110}
                                    value={destinationId}
                                    menuPortalZ={9999}
            ...
            <div className="mt-8 flex justify-between gap-4">
                ...
                >
                    {selectedOption === 'disable' &&
                        t('brands.deleteModal.confirmDisable')}
                    {selectedOption === 'move' &&
                        t('brands.deleteModal.confirmMove')}
                    {selectedOption === 'softDelete' &&
