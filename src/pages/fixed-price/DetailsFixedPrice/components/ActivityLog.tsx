...
const ActivityLog = ({ logs }: Props) => {
    ...
    return (
        <BackgroundRounded>
            <div className="p-6">
                <SectionHeader title={t('fixedPrice.details.activityLog') || 'Activity Log'} />
                        ...
                        <thead>
                            <tr className="border-b border-gray-100 dark:border-gray-800">
                                <th className="py-3 px-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">
                                    {t('fixedPrice.details.logItem') || 'Item'}
                                </th>
                                <th className="py-3 px-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">
                                    {t('fixedPrice.table.columns.createdAt') || 'Created at'}
                                </th>
                                <th className="py-3 px-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">
                                    {t('fixedPrice.details.reason') || 'Reason'}
                                </th>
                            </tr>
                        </thead>
