...
const ActivityLog = ({ logs }: Props) => {
    ...
    return (
        <BackgroundRounded>
            <div className="p-6">
                <SectionHeader title={t('durationAuctions.details.activityLog')} />
                        ...
                        <thead>
                            <tr className="border-b border-gray-100 dark:border-gray-800">
                                <th className="py-3 px-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">
                                    {t('durationAuctions.details.logItem')}
                                </th>
                                <th className="py-3 px-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">
                                    {t('durationAuctions.details.createdAt')}
                                </th>
                                <th className="py-3 px-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">
                                    {t('durationAuctions.details.reason')}
                                </th>
                            </tr>
                        </thead>
